...
-- Thời gian đã tạo: Th12 04, 2025 lúc 07:17 PM
...
CREATE TABLE `attendance` (
  ...
  `user_type` enum('doctor','reception','admin') COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `check_in_image` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Ảnh check in',
  `check_out_image` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Ảnh check out',
  `status` enum('checked_in','checked_out') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'checked_in',
  `location` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Vị trí chấm công (nếu có GPS)',
...
CREATE TABLE `bac_si` (
  ...
  `chuyen_khoa_id` int DEFAULT NULL,
  `chuyen_khoa` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `so_giay_phep` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `so_nam_kinh_nghiem` int DEFAULT '0',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `hinh_anh` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `face_encoding` text COLLATE utf8mb4_general_ci COMMENT 'Face encoding dạng JSON array',
  `face_encoding_updated` timestamp NULL DEFAULT NULL COMMENT 'Thời gian cập nhật face encoding',
  `trang_thai_truy_cap` enum('active','inactive','blocked','suspended') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'active' COMMENT 'Trạng thái truy cập: active=hoạt động, inactive=không hoạt động, blocked=bị chặn, suspended=tạm khóa'
...
(54, 'BS Siêu', 'sbxcvbxcb@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0123456788', 18, 'Siêu âm', '111', 20, '2025-10-10 19:52:54', '2025-12-04 18:37:49', NULL, NULL, NULL, 'inactive'),
(79, 'GSTS. bxcbxcvxcvbcxvb', 'vzxcv@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0123456780', 6, 'Mắt', 'TM001', 15, '2025-08-12 09:06:03', '2025-12-04 19:09:01', 'uploads/BS/bacsiviet.png', NULL, NULL, 'inactive'),
(80, 'Bác Sĩ X', 'xquang1231zxcvzxcv23@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0123456780', 16, 'Chẩn đoán hình ảnh', 'XQ001', 10, '2025-09-26 07:16:15', '2025-12-04 19:09:07', 'uploads/BS/Anh-bac-si-nam-8-min.jpg', NULL, NULL, 'inactive'),
(81, 'BS Nội Tổng Quát', 'bsonoitongquat@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000001', 13, 'Nội tổng quát', 'NTQ001', 8, '2025-12-01 15:40:00', '2025-12-04 19:09:18', 'uploads/BS/bác sĩ hải.png', NULL, NULL, 'inactive'),
(82, 'BS Ngoại Tổng Quát', 'bsngoaitongquat@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000002', 9, 'Ngoại tổng quát', 'NGTQ001', 10, '2025-12-01 16:00:00', '2025-12-04 19:09:22', NULL, NULL, NULL, 'inactive'),
(83, 'BS Nhi', 'bsnhi@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000003', 3, 'Nhi', 'NHI001', 7, '2025-12-01 16:00:00', '2025-12-04 19:09:26', NULL, NULL, NULL, 'inactive'),
(84, 'BS Sản', 'bssan@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000004', 4, 'Sản', 'SAN001', 9, '2025-12-01 16:00:00', '2025-12-04 19:09:31', NULL, NULL, NULL, 'inactive'),
(85, 'BS Mắt', 'bsmat@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000005', 6, 'Mắt', 'MAT001', 6, '2025-12-01 16:00:00', '2025-12-04 19:09:34', NULL, NULL, NULL, 'inactive'),
(86, 'BS Tai Mũi Họng', 'bstmh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000006', 7, 'Tai mũi họng', 'TMH001', 11, '2025-12-01 16:00:00', '2025-12-04 19:09:38', NULL, NULL, NULL, 'inactive'),
(87, 'BS Da Liễu', 'bsdalieu@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000007', 5, 'Da liễu', 'DL001', 5, '2025-12-01 16:00:00', '2025-12-04 19:09:41', NULL, NULL, NULL, 'inactive'),
(88, 'BS Nội Tim Mạch', 'bsnoitim@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000008', 1, 'Tim mạch', 'TM002', 12, '2025-12-01 16:00:00', '2025-12-04 19:09:45', NULL, NULL, NULL, 'inactive'),
(89, 'BS Hô Hấp', 'bshohap@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000009', NULL, 'Hô hấp', 'HH001', 10, '2025-12-01 16:00:00', '2025-12-04 19:09:48', NULL, NULL, NULL, 'inactive'),
(90, 'BS Thần Kinh', 'bsthankinh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000010', 2, 'Thần kinh', 'TK001', 13, '2025-12-01 16:00:00', '2025-12-04 19:09:51', NULL, NULL, NULL, 'inactive'),
(91, 'BS Cơ Xương Khớp', 'bscxk@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0909000011', 9, 'Cơ xương khớp', 'CXK001', 9, '2025-12-01 16:00:00', '2025-12-04 19:09:53', NULL, NULL, NULL, 'inactive');
...
CREATE TABLE `bao_hiem_y_te` (
  `id` int NOT NULL,
  `ma_bao_hiem` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `loai_the` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ten_chu_the` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngay_sinh` date DEFAULT NULL,
  `gioi_tinh` enum('Nam','nữ') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngay_bat_dau` date DEFAULT NULL,
  `ngay_het_han` date DEFAULT NULL,
  `noi_cap` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `trang_thai` enum('Hieu luc','Het han','Tam dung') COLLATE utf8mb4_general_ci DEFAULT 'Hieu luc',
...
(16, '0791034567', 'BHYT', 'Hoàng Nguyễn Phương Trang', '2003-01-10', 'nữ', '2023-01-01', '2024-12-31', 'Bảo hiểm xã hội TP.HCM', 'Hieu luc', 0.50),
...
CREATE TABLE `benh_nhan` (
  ...
  `bao_hiem_y_te` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `bao_hiem_y_te_id` int DEFAULT NULL,
  `ngay_sinh` date DEFAULT NULL,
  `gioi_tinh` enum('Nam','Nữ','Khác') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dia_chi` text COLLATE utf8mb4_general_ci,
  `cccd` varchar(12) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Căn cước công dân (12 số)',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `trang_thai_truy_cap` enum('active','inactive','blocked','suspended') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'active' COMMENT 'Trạng thái truy cập: active=hoạt động, inactive=không hoạt động, blocked=bị chặn, suspended=tạm khóa',
  `ma_benh_nhan` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(44, 'Lê Văn C', 'viet@gmail.com', '$2y$10$AgUQWduL/nIsAiFPVlbejOTtrmCdSwyN967rVW/JLJ/9UtZHSmo9.', '84913992110', 1, NULL, NULL, '1988-12-10', 'Nữ', 'Đà Nẵng', '003456789012', '2025-11-25 08:06:45', '2025-12-02 16:24:04', 'active', 'BN25112548'),
(58, 'Cao Dương Quốc Việt', 'caoduongvietquoc1@gmail.com', '$2y$10$KYRIaOkedJ1JnVGc8/7iDu/27k3TmhQAi.osH5ZseEBTxfQcRWQiu', '84913998110', 1, '0791034568', 17, '2003-03-22', 'Nam', 'An Giang', '001234567890', '2025-12-02 16:45:50', '2025-12-02 16:45:50', 'active', 'BN25120289'),
(59, 'Trần Văn Nam', 'tranvannam@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0923456789', 1, NULL, NULL, '1985-08-22', 'Nam', '456 Đường Nguyễn Huệ, Quận 1, TP.HCM', '001234567892', '2024-12-18 07:30:00', '2024-12-18 07:30:00', 'active', 'BN24121802'),
(60, 'Phạm Thị Lan', 'phamthilan@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0934567890', 1, NULL, NULL, '1992-11-10', 'Nữ', '789 Đường Điện Biên Phủ, Quận Bình Thạnh, TP.HCM', '001234567893', '2024-12-20 03:15:00', '2024-12-20 03:15:00', 'active', 'BN24122003'),
(61, 'Lê Văn Đức', 'levanduc@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0945678901', 1, NULL, NULL, '1987-03-25', 'Nam', '321 Đường Võ Văn Tần, Quận 3, TP.HCM', '001234567894', '2025-01-05 01:45:00', '2025-01-05 01:45:00', 'active', 'BN25010504'),
(62, 'Hoàng Thị Mai', 'hoangthimai@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0956789012', 1, NULL, NULL, '1995-07-18', 'Nữ', '654 Đường Cách Mạng Tháng 8, Quận 10, TP.HCM', '001234567895', '2025-01-10 04:20:00', '2025-01-10 04:20:00', 'active', 'BN25011005'),
(63, 'Võ Văn Tuấn', 'vovantuan@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0967890123', 1, NULL, NULL, '1989-12-05', 'Nam', '987 Đường Lý Thường Kiệt, Quận 11, TP.HCM', '001234567896', '2025-01-15 08:30:00', '2025-01-15 08:30:00', 'active', 'BN25011506'),
(64, 'Đặng Thị Hương', 'dangthihuong@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0978901234', 1, NULL, NULL, '1993-04-20', 'Nữ', '147 Đường Trường Chinh, Quận 12, TP.HCM', '001234567897', '2025-01-20 02:10:00', '2025-01-20 02:10:00', 'active', 'BN25012007'),
(65, 'Bùi Văn Hùng', 'buivanhung@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0989012345', 1, NULL, NULL, '1986-09-14', 'Nam', '258 Đường Nguyễn Trãi, Quận 5, TP.HCM', '001234567898', '2025-01-25 06:45:00', '2025-01-25 06:45:00', 'active', 'BN25012508'),
(66, 'Ngô Thị Thảo', 'ngothithao@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0990123456', 1, NULL, NULL, '1994-06-30', 'Nữ', '369 Đường Hùng Vương, Quận 5, TP.HCM', '001234567899', '2025-02-02 03:00:00', '2025-02-02 03:00:00', 'active', 'BN25020209'),
(67, 'Đỗ Văn Long', 'dovanlong@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0901234567', 1, NULL, NULL, '1984-01-08', 'Nam', '741 Đường Lạc Long Quân, Quận 11, TP.HCM', '001234567900', '2025-02-08 07:20:00', '2025-02-08 07:20:00', 'active', 'BN25020810'),
(68, 'Lý Thị Nga', 'lythinga@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0912345678', 1, NULL, NULL, '1991-10-12', 'Nữ', '852 Đường Tân Hương, Quận Tân Phú, TP.HCM', '001234567901', '2025-02-12 01:30:00', '2025-02-12 01:30:00', 'active', 'BN25021211'),
(69, 'Phan Văn Minh', 'phanvanminh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0923456789', 1, NULL, NULL, '1988-02-28', 'Nam', '963 Đường Lê Đức Thọ, Quận Gò Vấp, TP.HCM', '001234567902', '2025-02-18 04:15:00', '2025-02-18 04:15:00', 'active', 'BN25021812'),
(70, 'Vũ Thị Linh', 'vuthilinh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0934567890', 1, NULL, NULL, '1996-05-25', 'Nữ', '159 Đường Quang Trung, Quận Gò Vấp, TP.HCM', '001234567903', '2025-02-22 09:40:00', '2025-02-22 09:40:00', 'active', 'BN25022213'),
(71, 'Hồ Văn An', 'hovanan@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0945678901', 1, NULL, NULL, '1983-07-17', 'Nam', '357 Đường Nguyễn Oanh, Quận Gò Vấp, TP.HCM', '001234567904', '2025-02-28 02:25:00', '2025-02-28 02:25:00', 'active', 'BN25022814'),
(72, 'Dương Thị Hạnh', 'duongthihanh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0956789012', 1, NULL, NULL, '1990-12-03', 'Nữ', '468 Đường Phan Văn Trị, Quận Bình Thạnh, TP.HCM', '001234567905', '2025-03-05 05:50:00', '2025-03-05 05:50:00', 'active', 'BN25030515'),
(73, 'Nguyễn Văn Bình', 'nguyenvanbinh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0967890123', 1, NULL, NULL, '1985-04-19', 'Nam', '579 Đường Xô Viết Nghệ Tĩnh, Quận Bình Thạnh, TP.HCM', '001234567906', '2025-03-10 01:15:00', '2025-03-10 01:15:00', 'active', 'BN25031016'),
(74, 'Trịnh Thị Loan', 'trinhthiloan@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0978901234', 1, NULL, NULL, '1992-08-11', 'Nữ', '680 Đường Đinh Tiên Hoàng, Quận Bình Thạnh, TP.HCM', '001234567907', '2025-03-15 07:35:00', '2025-03-15 07:35:00', 'active', 'BN25031517'),
(75, 'Lương Văn Thành', 'luongvanthanh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0989012345', 1, NULL, NULL, '1987-11-26', 'Nam', '791 Đường Nguyễn Văn Đậu, Quận Bình Thạnh, TP.HCM', '001234567908', '2025-03-20 03:20:00', '2025-03-20 03:20:00', 'active', 'BN25032018'),
(76, 'Chu Thị Hồng', 'chuthihong@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0990123456', 1, NULL, NULL, '1994-03-09', 'Nữ', '802 Đường Nguyễn Gia Trí, Quận Bình Thạnh, TP.HCM', '001234567909', '2025-03-25 08:55:00', '2025-03-25 08:55:00', 'active', 'BN25032519'),
(77, 'Tạ Văn Sơn', 'tavanson@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0901234567', 1, NULL, NULL, '1986-06-22', 'Nam', '913 Đường Bạch Đằng, Quận Bình Thạnh, TP.HCM', '001234567910', '2025-03-30 04:10:00', '2025-03-30 04:10:00', 'active', 'BN25033020'),
(78, 'Đinh Thị Yến', 'dinhthiyen@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0912345678', 1, NULL, NULL, '1991-09-15', 'Nữ', '124 Đường Nguyễn Thái Sơn, Quận Gò Vấp, TP.HCM', '001234567911', '2025-04-05 02:40:00', '2025-04-05 02:40:00', 'active', 'BN25040521'),
(79, 'Vương Văn Dũng', 'vuongvandung@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0923456789', 1, NULL, NULL, '1984-12-07', 'Nam', '235 Đường Nguyễn Kiệm, Quận Phú Nhuận, TP.HCM', '001234567912', '2025-04-10 06:25:00', '2025-04-10 06:25:00', 'active', 'BN25041022'),
(80, 'Bạch Thị Trang', 'bachthitrang@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0934567890', 1, NULL, NULL, '1995-01-31', 'Nữ', '346 Đường Hoàng Văn Thụ, Quận Phú Nhuận, TP.HCM', '001234567913', '2025-04-15 01:50:00', '2025-04-15 01:50:00', 'active', 'BN25041523'),
(81, 'Lâm Văn Khánh', 'lamvankhanh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0945678901', 1, NULL, NULL, '1989-05-13', 'Nam', '457 Đường Phan Đăng Lưu, Quận Phú Nhuận, TP.HCM', '001234567914', '2025-04-20 07:15:00', '2025-04-20 07:15:00', 'active', 'BN25042024'),
(82, 'Tôn Thị Vân', 'tonthivan@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0956789012', 1, NULL, NULL, '1993-08-24', 'Nữ', '568 Đường Nguyễn Văn Trỗi, Quận Phú Nhuận, TP.HCM', '001234567915', '2025-04-25 03:30:00', '2025-04-25 03:30:00', 'active', 'BN25042525'),
(83, 'Mai Văn Hải', 'maivanhai@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0967890123', 1, NULL, NULL, '1988-02-16', 'Nam', '679 Đường Trần Hưng Đạo, Quận 1, TP.HCM', '001234567916', '2025-05-02 05:45:00', '2025-05-02 05:45:00', 'active', 'BN25050226'),
(84, 'Hà Thị Phương', 'hathiphuong@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0978901234', 1, NULL, NULL, '1990-07-29', 'Nữ', '780 Đường Pasteur, Quận 1, TP.HCM', '001234567917', '2025-05-08 02:20:00', '2025-05-08 02:20:00', 'active', 'BN25050827'),
(85, 'Quách Văn Tài', 'quachvantai@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0989012345', 1, NULL, NULL, '1985-10-04', 'Nam', '891 Đường Nam Kỳ Khởi Nghĩa, Quận 3, TP.HCM', '001234567918', '2025-05-12 08:10:00', '2025-05-12 08:10:00', 'active', 'BN25051228'),
(86, 'Lưu Thị Dung', 'luuthidung@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0990123456', 1, NULL, NULL, '1992-04-18', 'Nữ', '902 Đường Lê Văn Sỹ, Quận Phú Nhuận, TP.HCM', '001234567919', '2025-05-18 04:35:00', '2025-05-18 04:35:00', 'active', 'BN25051829'),
(87, 'Thạch Văn Lâm', 'thachvanlam@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0901234567', 1, NULL, NULL, '1987-01-21', 'Nam', '103 Đường Nguyễn Thị Minh Khai, Quận 3, TP.HCM', '001234567920', '2025-05-22 01:55:00', '2025-05-22 01:55:00', 'active', 'BN25052230'),
(88, 'Sơn Thị Hoa', 'sonthihoa@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0912345678', 1, NULL, NULL, '1994-11-08', 'Nữ', '214 Đường Võ Thị Sáu, Quận 3, TP.HCM', '001234567921', '2025-05-28 07:20:00', '2025-05-28 07:20:00', 'active', 'BN25052831'),
(89, 'Kiều Văn Đạt', 'kieuvandat@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0923456789', 1, NULL, NULL, '1986-03-12', 'Nam', '325 Đường Điện Biên Phủ, Quận Bình Thạnh, TP.HCM', '001234567922', '2025-06-03 03:15:00', '2025-06-03 03:15:00', 'active', 'BN25060332'),
(90, 'Đỗ Thị Quỳnh', 'dothiquynh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0934567890', 1, NULL, NULL, '1991-06-25', 'Nữ', '436 Đường Lê Đức Thọ, Quận Gò Vấp, TP.HCM', '001234567923', '2025-06-08 05:40:00', '2025-06-08 05:40:00', 'active', 'BN25060833'),
(91, 'Nguyễn Văn Tuấn', 'nguyenvantuan2@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0945678901', 1, NULL, NULL, '1988-09-19', 'Nam', '547 Đường Quang Trung, Quận Gò Vấp, TP.HCM', '001234567924', '2025-06-15 02:30:00', '2025-06-15 02:30:00', 'active', 'BN25061534'),
(92, 'Trần Thị Nhung', 'tranthinhung@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0956789012', 1, NULL, NULL, '1995-12-02', 'Nữ', '658 Đường Nguyễn Oanh, Quận Gò Vấp, TP.HCM', '001234567925', '2025-06-20 08:50:00', '2025-06-20 08:50:00', 'active', 'BN25062035'),
(93, 'Phạm Văn Huy', 'phamvanhuy@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0967890123', 1, NULL, NULL, '1984-04-14', 'Nam', '769 Đường Phan Văn Trị, Quận Bình Thạnh, TP.HCM', '001234567926', '2025-06-25 04:05:00', '2025-06-25 04:05:00', 'active', 'BN25062536'),
(94, 'Lê Thị Thúy', 'lethithuy@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0978901234', 1, NULL, NULL, '1993-07-27', 'Nữ', '870 Đường Xô Viết Nghệ Tĩnh, Quận Bình Thạnh, TP.HCM', '001234567927', '2025-07-02 01:25:00', '2025-07-02 01:25:00', 'active', 'BN25070237'),
(95, 'Hoàng Văn Cường', 'hoangvancuong@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0989012345', 1, NULL, NULL, '1989-10-09', 'Nam', '981 Đường Đinh Tiên Hoàng, Quận Bình Thạnh, TP.HCM', '001234567928', '2025-07-08 06:40:00', '2025-07-08 06:40:00', 'active', 'BN25070838'),
(96, 'Võ Thị Bích', 'vothibich@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0990123456', 1, NULL, NULL, '1990-01-23', 'Nữ', '092 Đường Nguyễn Gia Trí, Quận Bình Thạnh, TP.HCM', '001234567929', '2025-07-12 03:55:00', '2025-07-12 03:55:00', 'active', 'BN25071239'),
(97, 'Đặng Văn Thắng', 'dangvanthang@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0901234567', 1, NULL, NULL, '1985-05-06', 'Nam', '103 Đường Bạch Đằng, Quận Bình Thạnh, TP.HCM', '001234567930', '2025-07-18 07:10:00', '2025-07-18 07:10:00', 'active', 'BN25071840'),
(98, 'Bùi Thị Hạnh', 'buithihanh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0912345678', 1, NULL, NULL, '1992-08-19', 'Nữ', '214 Đường Nguyễn Thái Sơn, Quận Gò Vấp, TP.HCM', '001234567931', '2025-07-22 02:30:00', '2025-07-22 02:30:00', 'active', 'BN25072241'),
(99, 'Ngô Văn Sơn', 'ngovanson@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0923456789', 1, NULL, NULL, '1987-11-01', 'Nam', '325 Đường Nguyễn Kiệm, Quận Phú Nhuận, TP.HCM', '001234567932', '2025-07-28 05:45:00', '2025-07-28 05:45:00', 'active', 'BN25072842'),
(100, 'Lý Thị Hương', 'lythihuong@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0934567890', 1, NULL, NULL, '1994-02-14', 'Nữ', '436 Đường Hoàng Văn Thụ, Quận Phú Nhuận, TP.HCM', '001234567933', '2025-08-05 01:20:00', '2025-08-05 01:20:00', 'active', 'BN25080543'),
(101, 'Phan Văn Đức', 'phanvanduc@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0945678901', 1, NULL, NULL, '1986-05-28', 'Nam', '547 Đường Phan Đăng Lưu, Quận Phú Nhuận, TP.HCM', '001234567934', '2025-08-10 08:35:00', '2025-08-10 08:35:00', 'active', 'BN25081044'),
(102, 'Vũ Thị Lan', 'vuthilan@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0956789012', 1, NULL, NULL, '1991-09-11', 'Nữ', '658 Đường Nguyễn Văn Trỗi, Quận Phú Nhuận, TP.HCM', '001234567935', '2025-08-15 04:50:00', '2025-08-15 04:50:00', 'active', 'BN25081545'),
(103, 'Hồ Văn Tùng', 'hovantung@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0967890123', 1, NULL, NULL, '1988-12-24', 'Nam', '769 Đường Trần Hưng Đạo, Quận 1, TP.HCM', '001234567936', '2025-08-20 02:15:00', '2025-08-20 02:15:00', 'active', 'BN25082046'),
(104, 'Dương Thị Mai', 'duongthimai@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0978901234', 1, NULL, NULL, '1995-03-07', 'Nữ', '870 Đường Pasteur, Quận 1, TP.HCM', '001234567937', '2025-08-25 07:25:00', '2025-08-25 07:25:00', 'active', 'BN25082547'),
(105, 'Nguyễn Văn Hải', 'nguyenvanhai@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0989012345', 1, NULL, NULL, '1984-06-20', 'Nam', '981 Đường Nam Kỳ Khởi Nghĩa, Quận 3, TP.HCM', '001234567938', '2025-09-02 03:40:00', '2025-09-02 03:40:00', 'active', 'BN25090248'),
(106, 'Trịnh Thị Hoa', 'trinhthihoa@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0990123456', 1, NULL, NULL, '1993-10-03', 'Nữ', '092 Đường Lê Văn Sỹ, Quận Phú Nhuận, TP.HCM', '001234567939', '2025-09-08 01:55:00', '2025-09-08 01:55:00', 'active', 'BN25090849'),
(107, 'Lương Văn Thắng', 'luongvanthang@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0901234567', 1, NULL, NULL, '1987-01-16', 'Nam', '103 Đường Nguyễn Thị Minh Khai, Quận 3, TP.HCM', '001234567940', '2025-09-12 06:20:00', '2025-09-12 06:20:00', 'active', 'BN25091250'),
(108, 'Chu Thị Nga', 'chuthinga@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0912345678', 1, NULL, NULL, '1994-04-29', 'Nữ', '214 Đường Võ Thị Sáu, Quận 3, TP.HCM', '001234567941', '2025-09-18 04:35:00', '2025-09-18 04:35:00', 'active', 'BN25091851'),
(109, 'Tạ Văn Đạt', 'tavandat@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0923456789', 1, NULL, NULL, '1986-08-12', 'Nam', '325 Đường Điện Biên Phủ, Quận Bình Thạnh, TP.HCM', '001234567942', '2025-09-22 02:50:00', '2025-09-22 02:50:00', 'active', 'BN25092252'),
(110, 'Đinh Thị Quỳnh', 'dinhthiquynh@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0934567890', 1, NULL, NULL, '1991-11-25', 'Nữ', '436 Đường Lê Đức Thọ, Quận Gò Vấp, TP.HCM', '001234567943', '2025-09-28 08:05:00', '2025-09-28 08:05:00', 'active', 'BN25092853'),
(111, 'Vương Thị Trang', 'vuongthitrang@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0945678901', 1, NULL, NULL, '1988-02-08', 'Nữ', '547 Đường Quang Trung, Quận Gò Vấp, TP.HCM', '001234567944', '2025-10-05 05:20:00', '2025-10-05 05:20:00', 'active', 'BN25100554'),
(112, 'Bạch Văn Cường', 'bachvancuong@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0956789012', 1, NULL, NULL, '1995-05-21', 'Nam', '658 Đường Nguyễn Oanh, Quận Gò Vấp, TP.HCM', '001234567945', '2025-10-10 03:35:00', '2025-10-10 03:35:00', 'active', 'BN25101055'),
(113, 'Lâm Văn Huy', 'lamvanhuy@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0967890123', 1, NULL, NULL, '1989-09-04', 'Nam', '769 Đường Phan Văn Trị, Quận Bình Thạnh, TP.HCM', '001234567946', '2025-10-15 01:50:00', '2025-10-15 01:50:00', 'active', 'BN25101556'),
(114, 'Tôn Thị Thúy', 'tonthithuy@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0978901234', 1, NULL, NULL, '1992-12-17', 'Nữ', '870 Đường Xô Viết Nghệ Tĩnh, Quận Bình Thạnh, TP.HCM', '001234567947', '2025-10-20 07:10:00', '2025-10-20 07:10:00', 'active', 'BN25102057');
...
CREATE TABLE `bien_lai_vien_phi` (
  `id` int NOT NULL,
  `ma_bien_lai` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_phieu_kham_benh` int NOT NULL,
  `id_le_tan` int DEFAULT NULL COMMENT 'ID lễ tân lập biên lai',
  `id_bac_si` int DEFAULT NULL COMMENT 'ID bác sĩ khám bệnh',
  ...
  `nguoi_lap` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trang_thai` enum('Chưa thanh toán','Đã thanh toán tiền mặt','Đã thanh toán chuyển khoản','Hủy') COLLATE utf8mb4_unicode_ci DEFAULT 'Chưa thanh toán',
...
(16, 'BL202511271358', 40, 1, 1, 993000.00, 0.00, 993000.00, '2025-11-27 15:43:28', 'GSTS. Cao Việt', 'Chưa thanh toán', 'Biên lai tự động tạo từ hệ thống', '2025-11-27 08:43:28', '2025-12-04 15:37:21'),
...
CREATE TABLE `cccd_data` (
  `id` int NOT NULL,
  `cccd` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Số CCCD (12 số)',
  `ten` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Họ và tên',
  `ngay_sinh` date NOT NULL COMMENT 'Ngày sinh',
  `gioi_tinh` enum('Nam','Nữ') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Giới tính',
  `dia_chi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Địa chỉ thường trú',
  `ngay_cap` date DEFAULT NULL COMMENT 'Ngày cấp CCCD',
  `noi_cap` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nơi cấp CCCD',
...
CREATE TABLE `cham_cong` (
  `id` int NOT NULL,
  `user_id` int NOT NULL COMMENT 'ID của bác sĩ hoặc lễ tân',
  `user_type` enum('doctor','reception') COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Loại người dùng: bác sĩ hoặc lễ tân',
  ...
  `trang_thai` enum('check_in','check_out','completed') COLLATE utf8mb4_general_ci DEFAULT 'check_in' COMMENT 'Trạng thái: đã vào, đã ra, hoàn thành',
  `tre` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Trạng thái trễ: 0 = không trễ, 1 = trễ',
  `ghi_chu` text COLLATE utf8mb4_general_ci COMMENT 'Ghi chú (nếu có)',
  `face_id_data` text COLLATE utf8mb4_general_ci COMMENT 'Dữ liệu face recognition (embedding hoặc face ID)',
  `dia_diem` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Địa điểm chấm công (GPS location hoặc địa chỉ)',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `chi_so_xet_nghiem` (
  `id` int NOT NULL,
  `xet_nghiem` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên xét nghiệm',
  `gia_tri_tham_chieu` text COLLATE utf8mb4_unicode_ci COMMENT 'Giá trị tham chiếu',
  `don_vi` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Đơn vị đo',
  `chi_so_tu` float DEFAULT NULL COMMENT 'Chỉ số từ (ngưỡng dưới)',
  `chi_so_den` float DEFAULT NULL COMMENT 'Chỉ số đến (ngưỡng trên)',
  `may_qtkt` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Máy/Quy trình kỹ thuật',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `loai_form` enum('mau_toan_phan','mau_nuoc_tieu','other') COLLATE utf8mb4_unicode_ci DEFAULT 'other' COMMENT 'Loại form xét nghiệm',
  `thu_tu` int DEFAULT '0' COMMENT 'Thứ tự hiển thị trong form'
...
CREATE TABLE `chi_tiet_bien_lai` (
  `id` int NOT NULL,
  `id_bien_lai` int NOT NULL,
  `loai_dich_vu` enum('Kham benh','Xet nghiem','Sieu am','X-Quang','Thuoc') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `chi_tiet_don_thuoc` (
  ...
  `MaDonThuoc` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'FK -> don_thuoc.MaDonThuoc',
  `MaThuoc` varchar(10) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'FK -> thuoc.MaThuoc',
  `TenThuoc` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `HoatChat` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DonViTinh` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SoLuong` int NOT NULL DEFAULT '1',
  `LieuDung` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `GhiChu` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `NgayTao` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `NgayCapNhat` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `so_ngay` int NOT NULL DEFAULT '1' COMMENT 'Số ngày uống',
  `ghi_chu_cach_dung` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Ghi chú cách dùng chi tiết',
  ...
  `sang_bua` enum('none','before','after') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'none' COMMENT 'Bữa ăn buổi sáng',
  `trua_bua` enum('none','before','after') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'none' COMMENT 'Bữa ăn buổi trưa',
  `chieu_bua` enum('none','before','after') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'none' COMMENT 'Bữa ăn buổi chiều',
  `toi_bua` enum('none','before','after') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'none' COMMENT 'Bữa ăn buổi tối',
  `so_luong_tinh` int GENERATED ALWAYS AS (greatest(1,round((`so_ngay` * (((`vien_sang` + `vien_trua`) + `vien_chieu`) + `vien_toi`)),0))) STORED COMMENT 'SL tự tính = so_ngay * (tổng viên/ngày), tối thiểu 1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `chi_tiet_ket_qua_xet_nghiem` (
  `id` int NOT NULL,
  `id_phieu_tra_ket_qua` int NOT NULL COMMENT 'ID phiếu trả kết quả',
  `stt` int NOT NULL COMMENT 'Số thứ tự',
  `ten_xet_nghiem` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên xét nghiệm',
  `gia_tri_tham_chieu` text COLLATE utf8mb4_unicode_ci COMMENT 'Giá trị tham chiếu',
  `ket_qua` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Kết quả xét nghiệm',
  `don_vi` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Đơn vị đo',
  `may_qtkt` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Máy/Quy trình kỹ thuật',
  `ghi_chu` text COLLATE utf8mb4_unicode_ci COMMENT 'Ghi chú riêng cho từng xét nghiệm',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE `dich_vu_kham` (
  `id` int NOT NULL,
  `ten_dich_vu` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên dịch vụ khám bệnh',
  `don_gia` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'Đơn giá dịch vụ (VND)',
  `mo_ta` text COLLATE utf8mb4_unicode_ci COMMENT 'Mô tả chi tiết dịch vụ',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `don_thuoc` (
  `MaDonThuoc` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Prescription code',
  `MaBenhNhan` int NOT NULL COMMENT 'FK -> benh_nhan.id',
  `MaBacSi` int NOT NULL COMMENT 'FK -> bac_si.id',
  `id_phieu_kham_benh` int NOT NULL COMMENT 'FK -> phieu_kham_benh.id',
  `NgayKe` date NOT NULL,
  `ChanDoan` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `GhiChu` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TrangThai` varchar(20) COLLATE utf8mb4_general_ci DEFAULT 'nhap' COMMENT 'nhap/hoan_tat/huy',
  `NgayTao` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `face_encodings` (
  `id` int NOT NULL,
  `user_id` int NOT NULL COMMENT 'ID của nhân viên (bác sĩ, lễ tân, admin)',
  `user_type` enum('doctor','reception','admin') COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Loại nhân viên',
  `face_encoding` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Face encoding dạng JSON array',
  `sample_image_path` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Đường dẫn ảnh mẫu',
...
CREATE TABLE `ho_so_benh_an` (
  ...
  `chan_doan` text COLLATE utf8mb4_general_ci,
  `phac_do_dieu_tri` text COLLATE utf8mb4_general_ci,
  `don_thuoc` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `ket_qua_sieu_am` (
  `id` int NOT NULL,
  `id_phieu_yeu_cau_sieu_am` int NOT NULL,
  `ket_qua_khao_sat` text COLLATE utf8mb4_unicode_ci,
  `ket_luan` text COLLATE utf8mb4_unicode_ci,
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `bac_si_sieu_am` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tên bác sĩ siêu âm thực hiện và trả kết quả'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `ket_qua_xquang` (
  `id` int NOT NULL,
  `id_phieu_chup_xquang` int NOT NULL,
  `chuan_doan` text COLLATE utf8mb4_unicode_ci,
  `noi_dung` text COLLATE utf8mb4_unicode_ci,
  `ket_luan` text COLLATE utf8mb4_unicode_ci,
  `bac_si_xquang` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `le_tan` (
  ...
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `trang_thai_truy_cap` enum('active','inactive','blocked','suspended') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'active' COMMENT 'Trạng thái truy cập: active=hoạt động, inactive=không hoạt động, blocked=bị chặn, suspended=tạm khóa',
  `gioi_tinh` enum('Nam','Nữ') COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Lễ tân A', 'letanA@gmail.com', '$2y$10$6GgJ61STU3mG2zkFGZ4Eo.XeBivScR/N9wmFNVbLuFuGYcZs7ujPa', '0123456789', '[-0.06573474407196045,0.03764227405190468,0.057527586817741394,-0.07707465440034866,-0.11871064454317093,-0.010823025368154049,-0.02180519513785839,-0.11183173954486847,0.18018323183059692,-0.13357461988925934,0.24601903557777405,-0.07038712501525879,-0.19851765036582947,-0.030368227511644363,-0.008051705546677113,0.1534537971019745,-0.11838994920253754,-0.12378708273172379,-0.05542649328708649,-0.007045237813144922,-0.03083757311105728,-0.037622224539518356,0.04749597981572151,0.11376872658729553,-0.11832111328840256,-0.42543062567710876,-0.09991279244422913,-0.11489100009202957,-0.0021050579380244017,-0.04067635163664818,-0.0711786225438118,0.12506283819675446,-0.16585634648799896,-0.0232862439006567,0.03121650591492653,0.1718120276927948,-0.06937795132398605,-0.11234833300113678,0.18779054284095764,0.016915233805775642,-0.2613721787929535,0.017473649233579636,0.0707792267203331,0.24170248210430145,0.1106293573975563,0.029672931879758835,0.059409961104393005,-0.06450410932302475,0.13400697708129883,-0.19998705387115479,0.06549756228923798,0.13298961520195007,0.08191142976284027,0.05148254707455635,0.11899321526288986,-0.13552714884281158,0.07977843284606934,0.0769856795668602,-0.193703293800354,-0.01206957083195448,0.007090601604431868,-0.004906844347715378,0.04752223193645477,-0.07827597111463547,0.2606968581676483,0.16759911179542542,-0.090041883289814,-0.07362598925828934,0.14149659872055054,-0.1765335649251938,-0.049215178936719894,0.06316667050123215,-0.13149160146713257,-0.21352484822273254,-0.24791991710662842,0.014744344167411327,0.43069174885749817,0.18664467334747314,-0.14859862625598907,0.0782569870352745,-0.05190836638212204,-0.11115580797195435,0.08614616841077805,0.16838803887367249,-0.036773305386304855,0.0934930369257927,-0.06212441623210907,-0.0033806476276367903,0.24263936281204224,-0.024328045547008514,0.01695985160768032,0.2569752037525177,-0.005153202917426825,0.03779717907309532,0.03354061022400856,-0.01853351481258869,-0.11236885190010071,0.008325321599841118,-0.14803116023540497,-0.03465036675333977,-0.019427450373768806,-0.0616227462887764,-0.0309919323772192,0.03420470654964447,-0.2909732758998871,0.10098601132631302,0.014041723683476448,-0.051605790853500366,0.011785256676375866,0.047284748405218124,-0.08153553307056427,-0.06673174351453781,0.12190534174442291,-0.32261306047439575,0.1466260701417923,0.1617739051580429,0.054585933685302734,0.17512251436710358,0.09556174278259277,0.03113998845219612,0.04022065922617912,-0.0918903797864914,-0.12977954745292664,-0.05651572719216347,0.09357494115829468,-0.032869234681129456,0.032089486718177795,0.028893334791064262]', '2025-12-01 07:57:49', '2025-10-20 21:03:32', '2025-12-04 18:52:12', 'active', 'Nữ'),
...
CREATE TABLE `lich_hen` (
  ...
  `ly_do` text COLLATE utf8mb4_general_ci,
  `loai_lich` enum('Tư vấn','Trực tiếp','Tại nhà','Tại viện') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Trực tiếp',
  `dia_chi_kham` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `link_tu_van` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `trang_thai` enum('Chờ xác nhận','Đã xác nhận','Đang khám','Hoàn thành','Đã khám xong','hủy') COLLATE utf8mb4_general_ci DEFAULT 'Chờ xác nhận',
  `ghi_chu` text COLLATE utf8mb4_general_ci,
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(26, 58, 1, '2025-12-05', '07:00:00', '', 'Trực tiếp', NULL, '', 'Đang khám', NULL, '2025-12-04 15:28:20', '2025-12-04 15:30:36');
...
CREATE TABLE `lich_lam_viec` (
  `id` int NOT NULL,
  `bac_si_id` int NOT NULL,
  `thu_trong_tuan` enum('Thứ 2','Thứ 3','Thứ 4','Thứ 5','Thứ 6','Thứ 7','Chủ nhật') COLLATE utf8mb4_general_ci NOT NULL,
  `gio_bat_dau` time NOT NULL,
  `gio_ket_thuc` time NOT NULL,
  `loai_ca` enum('Ca sáng','Ca chiều','Ca tối') COLLATE utf8mb4_general_ci NOT NULL,
  `ghi_chu` text COLLATE utf8mb4_general_ci,
  `trang_thai` enum('active','inactive') COLLATE utf8mb4_general_ci DEFAULT 'active',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `lich_lam_viec_le_tan` (
  ...
  `gio_bat_dau` time NOT NULL,
  `gio_ket_thuc` time NOT NULL,
  `loai_ca` enum('Ca sáng','Ca chiều') COLLATE utf8mb4_general_ci NOT NULL,
  `ghi_chu` text COLLATE utf8mb4_general_ci,
  `trang_thai` enum('active','inactive') COLLATE utf8mb4_general_ci DEFAULT 'active',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `lich_lam_viec_le_tan_ngoai_le` (
  ...
  `ngay` date NOT NULL,
  `action` enum('cancel','modify') COLLATE utf8mb4_general_ci NOT NULL,
  `gio_bat_dau` time DEFAULT NULL,
  `gio_ket_thuc` time DEFAULT NULL,
  `loai_ca` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ghi_chu` text COLLATE utf8mb4_general_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `phieu_boc_so` (
  ...
  `bac_si_id` int NOT NULL,
  `lich_hen_id` int DEFAULT NULL,
  `trang_thai` enum('cho','dang_goi','dang_kham','bo_lo','xong','huy') COLLATE utf8mb4_general_ci DEFAULT 'cho',
  `uu_tien` tinyint DEFAULT '0',
  `quay` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ghi_chu` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `phieu_chup_xquang` (
  `id` int NOT NULL,
  `id_phieu_kham_benh` int NOT NULL,
  `so_dien_thoai` varchar(20) COLLATE utf8mb4_general_ci DEFAULT '0777871608',
  `quan` varchar(100) COLLATE utf8mb4_general_ci DEFAULT 'Gò Vấp',
  `yeu_cau_chup` text COLLATE utf8mb4_general_ci NOT NULL,
  `bac_si_kham` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `trang_thai` enum('Đã yêu cầu','Hoàn thành') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Đã yêu cầu',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `chan_doan_vao_vien` text COLLATE utf8mb4_general_ci COMMENT 'Chuẩn đoán nhập vào',
  `bac_si_xquang_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `phieu_kham_benh` (
  `id` int NOT NULL,
  `id_lich_hen` int DEFAULT NULL COMMENT 'ID lịch hẹn khám bệnh',
  `benh_nhan_id` int NOT NULL,
  `bac_si_id` int NOT NULL,
  `so_y_te` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `benh_vien` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `buong_kham` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ho_ten` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngay_sinh` tinyint UNSIGNED DEFAULT NULL,
  `thang_sinh` tinyint UNSIGNED DEFAULT NULL,
  `nam_sinh` smallint UNSIGNED DEFAULT NULL,
  `tuoi` tinyint UNSIGNED DEFAULT NULL,
  `gioi_tinh` enum('Nam','Nữ') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nghe_nghiep` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dan_toc` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngoai_kieu` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `noi_lam_viec` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dia_chi` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `bhyt_ngay` tinyint UNSIGNED DEFAULT NULL,
  `bhyt_thang` tinyint UNSIGNED DEFAULT NULL,
  `bhyt_nam` smallint UNSIGNED DEFAULT NULL,
  `so_the_bhyt` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dien_thoai_bao_tin` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gio_kham` tinyint UNSIGNED DEFAULT NULL,
  `phut_kham` tinyint UNSIGNED DEFAULT NULL,
  `ngay_kham` tinyint UNSIGNED DEFAULT NULL,
  `thang_kham` tinyint UNSIGNED DEFAULT NULL,
  `nam_kham` smallint UNSIGNED DEFAULT NULL,
  `chan_doan_gioi_thieu` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `qua_trinh_benh_li` text COLLATE utf8mb4_general_ci,
  `tien_su_ban_than` text COLLATE utf8mb4_general_ci,
  `tien_su_gia_dinh` text COLLATE utf8mb4_general_ci,
  `kham_toan_than` text COLLATE utf8mb4_general_ci,
  `mach` smallint DEFAULT NULL,
  ...
  `kham_cac_bo_phan` text COLLATE utf8mb4_general_ci,
  `tom_tat_lam_sang` text COLLATE utf8mb4_general_ci,
  `chan_doan_vao_vien` text COLLATE utf8mb4_general_ci,
  `da_xu_li` text COLLATE utf8mb4_general_ci,
  `khoa_dieu_tri` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `chu_y` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngay_ky` tinyint UNSIGNED DEFAULT NULL,
  `thang_ky` tinyint UNSIGNED DEFAULT NULL,
  `nam_ky` smallint UNSIGNED DEFAULT NULL,
  `ten_bac_si` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `lich_hen` int DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `phieu_tien_su_di_ung` (
  `id` int NOT NULL,
  `benh_nhan_id` int NOT NULL,
  `thuoc_hoac_di_nguyen` text COLLATE utf8mb4_general_ci,
  `so_lan_thuoc` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `khong_thuoc` tinyint(1) NOT NULL DEFAULT '0',
  `ghi_chu_thuoc` text COLLATE utf8mb4_general_ci,
  `con_trung` text COLLATE utf8mb4_general_ci,
  `so_lan_con_trung` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `khong_con_trung` tinyint(1) NOT NULL DEFAULT '0',
  `ghi_chu_con_trung` text COLLATE utf8mb4_general_ci,
  `thuc_pham` text COLLATE utf8mb4_general_ci,
  `so_lan_thuc_pham` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `khong_thuc_pham` tinyint(1) NOT NULL DEFAULT '0',
  `ghi_chu_thuc_pham` text COLLATE utf8mb4_general_ci,
  `tac_nhan_khac` text COLLATE utf8mb4_general_ci,
  `so_lan_tac_nhan_khac` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `khong_tac_nhan_khac` tinyint(1) NOT NULL DEFAULT '0',
  `ghi_chu_tac_nhan_khac` text COLLATE utf8mb4_general_ci,
  `tien_su_ca_nhan` text COLLATE utf8mb4_general_ci,
  `so_lan_tien_su_ca_nhan` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `khong_tien_su_ca_nhan` tinyint(1) NOT NULL DEFAULT '0',
  `ghi_chu_tien_su_ca_nhan` text COLLATE utf8mb4_general_ci,
  `tien_su_gia_dinh` text COLLATE utf8mb4_general_ci,
  `so_lan_tien_su_gia_dinh` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `khong_tien_su_gia_dinh` tinyint(1) NOT NULL DEFAULT '0',
  `ghi_chu_tien_su_gia_dinh` text COLLATE utf8mb4_general_ci,
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `phieu_tra_ket_qua_xet_nghiem` (
  `id` int NOT NULL,
  `id_phieu_yeu_cau` int NOT NULL COMMENT 'ID phiếu yêu cầu xét nghiệm',
  `id_benh_nhan` int NOT NULL COMMENT 'ID bệnh nhân',
  `ma_benh_nhan` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Mã bệnh nhân',
  `ho_ten` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Họ tên bệnh nhân',
  `tuoi` tinyint UNSIGNED NOT NULL COMMENT 'Tuổi',
  `gioi_tinh` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Giới tính',
  `dia_chi` text COLLATE utf8mb4_unicode_ci COMMENT 'Địa chỉ',
  `chan_doan_so_bo` text COLLATE utf8mb4_unicode_ci COMMENT 'Chẩn đoán sơ bộ',
  `tinh_trang_mau` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tình trạng mẫu',
  `vi_tri_lay_mau` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Vị trí lấy mẫu',
  `bac_si_yeu_cau` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Bác sĩ yêu cầu',
  `bac_si_xet_nghiem` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Bác sĩ xét nghiệm',
  `ngay_dang_ky` datetime NOT NULL COMMENT 'Ngày đăng ký',
  `ngay_tra_ket_qua` date NOT NULL COMMENT 'Ngày trả kết quả',
  `trang_thai` enum('Đã trả kết quả','Đã in','Đã gửi') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Đã trả kết quả',
...
CREATE TABLE `phieu_yeu_cau_sieu_am` (
  `id` int NOT NULL,
  `id_phieu_kham_benh` int NOT NULL COMMENT 'FK -> phieu_kham_benh.id',
  `so_ho_so` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mã bệnh nhân (ma_benh_nhan)',
  `ho_ten` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gioi_tinh` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `doi_tuong` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'BHYT / Thu phí',
  `so_the_bhyt` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phong_kham` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chan_doan` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `yeu_cau` text COLLATE utf8mb4_unicode_ci COMMENT 'Yêu cầu siêu âm (có thể nhiều mục, ngăn cách bằng dấu phẩy)',
  `bac_si_kham` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thoi_gian_yeu_cau` datetime DEFAULT NULL,
  `bac_si_sieu_am_id` int DEFAULT NULL,
  `trang_thai` enum('Đã yêu cầu','Hoàn thành') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Đã yêu cầu',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `phieu_yeu_cau_xet_nghiem` (
  `id` int NOT NULL,
  `id_phieu_kham_benh` int DEFAULT NULL,
  `so_ho_so` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ho_ten` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tuoi` tinyint UNSIGNED DEFAULT NULL,
  `gioi_tinh` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `doi_tuong` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'BHYT / Thu phí',
  ...
  `phong_kham` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chan_doan` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `yeu_cau` text COLLATE utf8mb4_unicode_ci COMMENT 'Yêu cầu xét nghiệm (có thể nhiều mục, ngăn cách bằng dấu phẩy)',
  `bac_si_kham` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thoi_gian_yeu_cau` datetime DEFAULT NULL,
  `bac_si_xet_nghiem_id` int DEFAULT NULL,
  `trang_thai` enum('Đã yêu cầu','Hoàn thành') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Đã yêu cầu',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'admin', 'admin@gmail.com', '$2y$10$yhTSpU/RsVsqqst2e48peOojd/lGjmkkO30KVX3rTHXrkCcG65oR6', '0123456789', NULL, NULL, '2025-08-12 07:44:29', '2025-09-06 08:35:36', 'active');
...
CREATE TABLE `sieuam_suggestions` (
  `id` int NOT NULL,
  `ten_goi_y` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên gợi ý Siêu âm',
  `gia_tien` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'Giá tiền (VNĐ)',
  `mo_ta` text COLLATE utf8mb4_unicode_ci,
  `loai_chup` enum('Ổ bụng','Sản phụ khoa','Tim mạch','Mạch máu','Tuyến - đầu cổ','Cơ xương khớp','Khác') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Khác',
...
CREATE TABLE `sieu_am_hinh_anh` (
  `id` int NOT NULL,
  `id_ket_qua_sieu_am` int NOT NULL,
  `ten_file` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `duong_dan` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kich_thuoc` int DEFAULT NULL COMMENT 'Kích thước file tính bằng bytes',
  `loai_file` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'image/jpeg, image/png, etc.',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `thong_bao` (
  `id` int NOT NULL,
  `doi_tuong` enum('bac_si','benh_nhan','quan_tri_vien') COLLATE utf8mb4_general_ci NOT NULL,
  `bac_si_id` int DEFAULT NULL,
  `benh_nhan_id` int DEFAULT NULL,
  `quan_tri_vien_id` int DEFAULT NULL,
  `loai` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'info',
  `noi_dung` text COLLATE utf8mb4_general_ci NOT NULL,
  `du_lieu_kem_theo` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
(57, 'benh_nhan', NULL, 58, NULL, 'success', 'Bạn đã đặt lịch hẹn thành công với bác sĩ GSTS. Cao Việt vào 05-12-2025 lúc 07:00', '{\"patientId\":58,\"doctorId\":\"1\",\"doctorName\":\"GSTS. Cao Việt\",\"appointmentDate\":\"2025-12-05\",\"appointmentTime\":\"07:00\",\"message\":\"Bạn đã đặt lịch hẹn thành công với bác sĩ GSTS. Cao Việt vào 05-12-2025 lúc 07:00\",\"timestamp\":\"2025-12-04 22:28:21\"}', 1, '2025-12-04 15:28:21'),
(58, 'benh_nhan', NULL, 58, NULL, 'info', 'Bác sĩ GSTS. Cao Việt đã cập nhật trạng thái lịch hẹn ngày 05-12-2025 thành: Đã xác nhận', '{\"appointmentId\":26,\"patientId\":58,\"doctorId\":1,\"patientName\":\"Cao Dương Quốc Việt\",\"doctorName\":\"GSTS. Cao Việt\",\"appointmentDate\":\"2025-12-05\",\"appointmentTime\":\"07:00:00\",\"newStatus\":\"Đã xác nhận\",\"note\":\"\",\"timestamp\":\"2025-12-04 22:30:21\",\"message\":\"Bác sĩ GSTS. Cao Việt đã cập nhật trạng thái lịch hẹn ngày 05-12-2025 thành: Đã xác nhận\"}', 1, '2025-12-04 15:30:21');
...
CREATE TABLE `thuoc` (
  `MaThuoc` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `TenThuoc` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `HoatChatChinh` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `DangBaoChe` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `DonViTinh` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `HamLuong` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `ChiDinh` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `ChongChiDinh` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `LieuDung` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `DonGia` decimal(10,2) DEFAULT NULL,
  `SoLuongTon` int DEFAULT '0',
  `NgaySanXuat` date DEFAULT NULL,
  `HanSuDung` date DEFAULT NULL,
  `NhaSanXuat` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `NuocSanXuat` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `xet_nghiem_suggestions` (
  `id` int NOT NULL,
  `ten_goi_y` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên gợi ý xét nghiệm',
  `gia_tien` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'Giá tiền (VNĐ)',
  `mo_ta` text COLLATE utf8mb4_unicode_ci,
  `loai_xet_nghiem` enum('Huyết học','Sinh hóa','Vi sinh','Miễn dịch','Nội tiết','Khác') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Khác',
  `trang_thai` tinyint(1) NOT NULL DEFAULT '1',
  `thu_tu` int DEFAULT '0',
  `ngay_tao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ngay_cap_nhat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `xray_suggestions` (
  `id` int NOT NULL,
  `ten_goi_y` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên gợi ý X-Quang',
  `gia_tien` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'Giá tiền (VNĐ)',
  `mo_ta` text COLLATE utf8mb4_unicode_ci COMMENT 'Mô tả chi tiết',
  `loai_chup` enum('Xương','Ngực','Cột sống','Khớp','Sọ mặt','Khác') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Khác' COMMENT 'Loại chụp',
...
--
ALTER TABLE `chi_tiet_don_thuoc`
  MODIFY `MaChiTiet` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
