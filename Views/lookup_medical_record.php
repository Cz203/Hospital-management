        ...
        <div class="lookup-card">
            ...
            <?php if (!empty($hoTen) && !empty($soDienThoai) && !empty($cccd)): ?>
                <div style="text-align: center; margin-bottom: 20px;">
                    <a href="./lookup_medical_record?clear=1" 
                       class="btn-search" 
                ...
                <div class="records-section">
                    <?php if ($patient): ?>
                        <div class="patient-info">
                            ...
                            <p><strong>Mã bệnh nhân:</strong> <?php echo htmlspecialchars($patient['ma_benh_nhan'] ?? '-'); ?></p>
                            <p><strong>Số điện thoại:</strong> <?php echo htmlspecialchars($patient['so_dien_thoai'] ?? '-'); ?></p>
                        ...
                        <?php if (!empty($records)): ?>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                                ...
                                <form method="GET" action="./lookup_medical_record" style="display: flex; gap: 10px; align-items: center;">
                                    <label for="filter_date" style="margin: 0; font-weight: 600; color: #333;">Lọc theo ngày:</label>
                                    <input type="date" 
                                           name="selected_date" 
                                           id="filter_date" 
                                           class="form-control" 
                                    ...
                                    <li class="record-item">
                                        ...
                                        <div class="record-details">
                                            <?php if (!empty($record['ten_bac_si_full']) || !empty($record['ten_bac_si'])): ?>
                                                <p><strong>Bác sĩ khám:</strong> <?php echo htmlspecialchars($record['ten_bac_si_full'] ?? $record['ten_bac_si'] ?? '-'); ?></p>
                                            <?php endif; ?>
                                            <?php if (!empty($record['chan_doan_vao_vien'])): ?>
                                                <p><strong>Chẩn đoán:</strong> <?php echo htmlspecialchars($record['chan_doan_vao_vien']); ?></p>
                                            <?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger">
                            <i class="icofont-warning"></i> Không tìm thấy hồ sơ với thông tin đã nhập. Vui lòng kiểm tra lại thông tin!
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
