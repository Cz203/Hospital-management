...
$page_title = 'Đặt lịch tư vấn trực tuyến';
            ...
            <div class="col-lg-10 text-center">
                <div class="section-title">
                    <h2 class="text-white mb-3">
                        <i class="icofont-video-cam mr-2" style="color: #e12454;"></i>
                        Đặt lịch tư vấn trực tuyến
                    </h2>
                    <div class="divider mx-auto my-4" style="background: rgba(255,255,255,0.3);"></div>
                    <p class="text-white-50">Tư vấn với bác sĩ qua video call, tiện lợi và an toàn</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section consultation-booking-section"
            ...
            <div class="col-lg-10 col-xl-9">
                ...
                <div class="unified-appointment-card">
                    <div class="card-header-custom">
                        <h4 class="mb-0">
                            <i class="icofont-video-cam mr-2"></i>
                            Đặt lịch tư vấn trực tuyến
                        </h4>
                    </div>
                    <div class="card-body-custom">
                        ...
                        <div class="doctor-info-card mb-4">
                            ...
                            <div class="doctor-info-content">
                                ...
                                <div class="consultation-badge mt-2">
                                    <i class="icofont-video-cam mr-1"></i>
                        ...
                        <form id="appointmentForm" method="POST" action="./book_appointment">
                            ...
                            <div class="form-group-custom mb-4">
                                <label class="form-label-custom">
                                    ...
                                    Lý do tư vấn <span class="text-danger">*</span>
                                </label>
                                ...
                                <small class="form-text-custom">Mô tả chi tiết để bác sĩ có thể tư vấn tốt nhất cho
                                    bạn.</small>
                            </div>
                            ...
                            <div class="form-group-custom mb-4">
                                <label class="form-label-custom">
                                    <i class="icofont-note mr-2"></i>
                                    Ghi chú thêm
                                </label>
                                <textarea id="appointmentNotes" name="notes" class="form-control-custom" rows="3"
                                    placeholder="Thông tin bổ sung (nếu có)..."></textarea>
                                <small class="form-text-custom">Bạn có thể thêm thông tin khác về tình trạng sức khỏe
                                    của mình.</small>
                            </div>
                ...
                <div class="unified-appointment-card">
                    <div class="card-body-custom">
                        <div class="alert alert-warning text-center mb-0">
                            ...
                            Vui lòng chọn bác sĩ trước khi đặt lịch tư vấn.
