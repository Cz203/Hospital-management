...
<ul class="nav nav-tabs mb-3" id="detailTabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-lab-request" data-bs-toggle="tab" data-bs-target="#pane-lab-request" type="button" role="tab">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-ultrasound-request" data-bs-toggle="tab" data-bs-target="#pane-ultrasound-request" type="button" role="tab">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-xray-request" data-bs-toggle="tab" data-bs-target="#pane-xray-request" type="button" role="tab">
