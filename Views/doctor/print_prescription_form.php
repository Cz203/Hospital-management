...
<body>
    ...
    <div class="header">
        ...
        <div class="prescription-id">Mã đơn thuốc: <?php echo htmlspecialchars($prescriptionData['MaDonThuoc'] ?? ''); ?></div>
    </div>
    ...
    <div class="patient-info-section">
        <div class="patient-info-left">
            <div class="info-row">
                ...
                <div class="info-value"><?php echo !empty($prescriptionData['ho_ten']) ? htmlspecialchars($prescriptionData['ho_ten']) : '...'; ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Mã Bệnh nhân:</div>
                <div class="info-value"><?php echo !empty($prescriptionData['ma_benh_nhan']) ? htmlspecialchars($prescriptionData['ma_benh_nhan']) : '...'; ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Mã số BHYT (nếu có):</div>
                <div class="info-value"><?php echo !empty($prescriptionData['so_the_bhyt']) ? htmlspecialchars($prescriptionData['so_the_bhyt']) : 'Thu phí'; ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Địa chỉ liên hệ:</div>
                <div class="info-value"><?php echo !empty($prescriptionData['dia_chi']) ? htmlspecialchars($prescriptionData['dia_chi']) : '...'; ?></div>
            </div>
        </div>
        ...
        <div class="patient-info-right">
            <div class="info-row">
                ...
                <div class="info-value"><?php echo !empty($prescriptionData['ngay_sinh']) ? htmlspecialchars($prescriptionData['ngay_sinh']) : '...'; ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Giới tính:</div>
                <div class="info-value"><?php echo !empty($prescriptionData['gioi_tinh']) ? htmlspecialchars($prescriptionData['gioi_tinh']) : '...'; ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Số điện thoại:</div>
                <div class="info-value"><?php echo !empty($prescriptionData['so_dien_thoai']) ? htmlspecialchars($prescriptionData['so_dien_thoai']) : '...'; ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="signature-section">
        <div class="signature-box">
            <div class="signature-date"><?php 
                // Set timezone to Vietnam
                date_default_timezone_set('Asia/Ho_Chi_Minh');
                echo date('d/m/Y'); 
            ?></div>
            <div class="signature-label">Bác sỹ ký tên</div>
            <div class="doctor-name"><?php echo htmlspecialchars($prescriptionData['ten_bac_si'] ?? 'GSTS. Cao Việt'); ?></div>
        </div>
    </div>
