...
$sieuamDoctorSessionName = (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'sieuam_doctor') ? $_SESSION['user_name'] : '';
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Chào mừng bác sĩ Siêu âm ' . $_SESSION['user_name'] . ' - Chẩn đoán siêu âm</p>
        </div>
    ...
    fetch(`./?action=get_ultrasound_result&id=${id}`)
        ...
        .then(data => {
            if (data.success && data.result) {
                ...
                document.getElementById('ur_vung_khao_sat').textContent = result.yeu_cau || 'SIÊU ÂM BỤNG TỔNG QUÁT MÀU';
                ...
                document.getElementById('ur_bac_si_doc').textContent = '<?php echo $_SESSION['user_name']; ?>';
...
function setupZoomControls() {
    ...
    document.addEventListener('mousemove', function(e) {
        if (isPanning && scale > 1) {
            ...
            image.style.transform = `translate(${translateValues[0] + deltaX}px, ${translateValues[1] + deltaY}px) scale(${scale})`;
            startPoint = endPoint;
        }
    });
