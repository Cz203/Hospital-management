...
<body>
    ...
    <!-- Top Notification Bar (chỉ hiển thị cho doctor và letan) -->
    <?php if (in_array($user_role, ['doctor', 'xray_doctor', 'sieuam_doctor', 'xetnghiem_doctor', 'letan'])): ?>
        <div id="topNotificationBar" class="alert alert-info alert-dismissible fade show mb-0" role="alert"
            style="display: none; border-radius: 0; position: sticky; top: 0; z-index: 1050;">
            <div class="container-fluid">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <i class="fas fa-bell me-2"></i>
                        <span id="topNotificationText"></span>
                    </div>
                    <button type="button" class="btn-close" onclick="closeTopNotification()" aria-label="Close"></button>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <!-- Top Notification Functions (cho doctor và letan) -->
    <script>
        // Function để hiển thị thông báo ở đầu trang
        function showTopNotification(message, type = 'success') {
            ...
            if (!topNotificationBar || !topNotificationText) {
                return; // Không có notification bar (không phải doctor/letan)
            }

            // Đổi màu theo type
            topNotificationBar.className = 'alert alert-' + type + ' alert-dismissible fade show mb-0';
