<div class="sidebar bg-dark text-white"
    ...
    <div class="sidebar-body p-0">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link text-white py-3 px-3 d-flex align-items-center <?php echo isActiveUrl('admin_appointments'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link text-white py-3 px-3 d-flex align-items-center <?php echo isActiveUrl('admin_reception_schedules'); ?>"
