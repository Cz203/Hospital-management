...
<div class="sidebar text-white"
    ...
    <div class="p-4">
        ...
        <nav class="nav flex-column">
            <!-- Dashboard -->
            <a class="nav-link text-white py-3 <?php echo isActiveUrl('xray_dashboard') ? 'active bg-light' : ''; ?>"
                href="./xray_dashboard"
                style="<?php echo isActiveUrl('xray_dashboard') ? 'color: #0d6efd !important;' : ''; ?>">
            ...
            <!-- History -->
            <a class="nav-link text-white py-3 <?php echo isActiveUrl('xray_history') ? 'active bg-light' : ''; ?>"
                href="./xray_history"
                style="<?php echo isActiveUrl('xray_history') ? 'color: #0d6efd !important;' : ''; ?>">
                <i class="fas fa-history me-2"></i>
                Lịch sử chụp X-Quang
            </a>

            <!-- Settings -->
            <a class="nav-link text-white py-3 <?php echo isActiveUrl('xray_settings') ? 'active bg-light' : ''; ?>"
                href="./xray_settings"
                style="<?php echo isActiveUrl('xray_settings') ? 'color: #0d6efd !important;' : ''; ?>">
