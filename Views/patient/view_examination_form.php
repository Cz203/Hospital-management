        ...
        <div class="pdf-content">
            <?php if ($exam && !empty($exam['id'])): ?>
                ...
                <div class="topline small">
                    <div>Sở y tế: <span class="fill" style="min-width:180px; display:inline-block;"><?= $safe($exam['so_y_te'] ?? '') ?></span></div>
                    <div>MS: <strong><?= (int)$exam['id'] ?></strong></div>
                </div>
                <div class="topline small">
                    <div>Bệnh viện: <span class="fill" style="min-width:220px; display:inline-block;"><?= $safe($exam['benh_vien'] ?? '') ?></span></div>
                    <div>Mã bệnh nhân: <span class="fill" style="min-width:160px; display:inline-block;"><?= $safe($maBenhNhan) ?></span></div>
                </div>
                <div class="topline small">
                    <div></div>
                    <div>BUỒNG KHÁM BỆNH: <span class="fill" style="min-width:200px; display:inline-block;"><?= $safe($exam['buong_kham'] ?? '') ?></span></div>
                </div>
                ...
                <div class="line">
                    ...
                    <span class="gap" style="width:16px"></span>Giới: 1. Nam <span class="box <?= $yes(trim($exam['gioi_tinh'] ?? '')==='Nam') ?>"></span>
                    <span class="gap"></span>2. Nữ <span class="box <?= $yes(trim($exam['gioi_tinh'] ?? '')==='Nữ' || trim($exam['gioi_tinh'] ?? '')==='Nu') ?>"></span>
                </div>
                <div class="line"><span class="idx">3.</span><span class="lbl">Nghề nghiệp:</span><span class="fill"><?= $safe($exam['nghe_nghiep'] ?? '') ?></span></div>
                <div class="line"><span class="idx">4.</span><span class="lbl">Dân tộc:</span><span class="fill"><?= $safe($exam['dan_toc'] ?? '') ?></span>
                    <span class="gap"></span><span class="lbl" style="min-width:100px;">Ngoại kiều:</span><span class="fill"><?= $safe($exam['ngoai_kieu'] ?? '') ?></span>
                </div>
                <div class="line"><span class="idx">5.</span><span class="lbl">Nơi làm việc:</span><span class="fill"><?= $safe($exam['noi_lam_viec'] ?? '') ?></span></div>
                <div class="line"><span class="idx">6.</span><span class="lbl">Địa chỉ:</span><span class="fill"><?= $safe($exam['dia_chi'] ?? '') ?></span></div>
                <div class="line"><span class="idx">7.</span><span class="lbl">Đối tượng:</span>
                    <span class="checkboxes">
                        ...
                        <span class="cb">2. Thu phí <span class="box <?= $yes($exam['doi_tuong_thu_phi'] ?? 0) ?>"></span></span>
                ...
                <div class="line"><span class="idx">10.</span><span class="lbl">BHYT giá trị đến:</span>
                    ...
                    <span class="gap" style="width:16px"></span>Số thẻ BHYT: <span class="fill" style="min-width:220px; display:inline-block;"><?= $safe($exam['so_the_bhyt'] ?? '') ?></span>
                </div>
                <div class="line"><span class="idx">11.</span><span class="lbl">Điện thoại người báo tin:</span><span class="fill"><?= $safe($exam['dien_thoai_bao_tin'] ?? '') ?></span></div>
                ...
                <div class="line"><span class="idx">13.</span><span class="lbl">Chẩn đoán nơi giới thiệu:</span><span class="fill"><?= $safe($exam['chan_doan_gioi_thieu'] ?? '') ?></span></div>
                ...
                <div class="two-col">
                    <div class="col">
                        ...
                        <div class="line"><span class="idx">6.</span><span class="lbl">Cho vào điều trị tại khoa:</span><span class="fill"><?= $safe($exam['khoa_dieu_tri'] ?? '') ?></span></div>
                        <div class="line"><span class="idx">7.</span><span class="lbl">Chú ý:</span><span class="fill"><?= $safe($exam['chu_y'] ?? '') ?></span></div>
                    </div>
                    <div class="vitals">
                        <div class="vrow"><span class="vlabel">Mạch:</span><span class="fill" style="border:0;border-bottom:1px dotted #000;"><?= $safe($exam['mach'] ?? '') ?></span> lần/phút</div>
                        <div class="vrow"><span class="vlabel">Nhiệt độ:</span><span class="fill" style="border:0;border-bottom:1px dotted #000;"><?= $safe($exam['nhiet_do'] ?? '') ?></span> °C</div>
                        <div class="vrow"><span class="vlabel">Huyết áp:</span><span class="fill" style="border:0;border-bottom:1px dotted #000;"><?= $safe($exam['huyet_ap_tam_thu'] ?? '') ?></span>/<span class="fill" style="border:0;border-bottom:1px dotted #000; max-width:60px; display:inline-block;"><?= $safe($exam['huyet_ap_tam_truong'] ?? '') ?></span> mmHg</div>
                        <div class="vrow"><span class="vlabel">Nhịp thở:</span><span class="fill" style="border:0;border-bottom:1px dotted #000;"><?= $safe($exam['nhip_tho'] ?? '') ?></span> lần/phút</div>
                    </div>
                </div>
                ...
                <div style="margin-top: 30px; text-align: right;">
                    <div style="display: inline-block; text-align: center;">
                        <div style="margin-bottom: 15px;">
                            <span>Ngày</span>
                            <span style="display: inline-block; width: 60px; margin: 0 5px; border-bottom: 1px solid #000; text-align: center;"><?= $safe($exam['ngay_ky'] ?? '') ?></span>
                            <span>tháng</span>
                            <span style="display: inline-block; width: 60px; margin: 0 5px; border-bottom: 1px solid #000; text-align: center;"><?= $safe($exam['thang_ky'] ?? '') ?></span>
                            <span>năm</span>
                            <span style="display: inline-block; width: 80px; margin: 0 5px; border-bottom: 1px solid #000; text-align: center;"><?= $safe($exam['nam_ky'] ?? '') ?></span>
                        </div>
                        <div>
