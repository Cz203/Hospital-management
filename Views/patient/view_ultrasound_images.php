<?php
/**
 * View hình ảnh Siêu âm cho Patient
 */

$exam = $data['exam'] ?? [];
$ultrasoundResult = $data['ultrasound_result'] ?? null;
$ultrasoundImages = $data['ultrasound_images'] ?? [];
...
<body>
    <div class="pdf-viewer-container">
        ...
        <div class="pdf-content">
            <?php if (!empty($ultrasoundImages) && is_array($ultrasoundImages) && count($ultrasoundImages) > 0): ?>
                <!-- Header -->
                <div class="header">
                    <img src="assets/img/logophieu/gen-n-logophieu.jpg" alt="Logo">
                    <h1>HÌNH ẢNH SIÊU ÂM</h1>
                </div>
                ...
                <div class="image-gallery">
                    <?php foreach ($ultrasoundImages as $img): ?>
                        <?php if (!empty($img['duong_dan'])): ?>
                            <div class="image-item" onclick="openImageZoom('<?php echo escapeHtml($img['duong_dan']); ?>')">
                                <img src="<?php echo escapeHtml($img['duong_dan']); ?>" alt="Hình siêu âm">
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
