<?php
/**
 * View phiếu chỉ định siêu âm cho Patient - PDF-like interface (chỉ phiếu yêu cầu)
 */
...
<head>
    ...
    <title>Phiếu Chỉ Định Siêu Âm</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="pdf-viewer-container">
        ...
        <div class="pdf-content">
                ...
                <div class="form-section">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo escapeHtml($ultrasoundRequest['phong_kham'] ?? 'Thịnh Việt'); ?>" readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group" style="flex: 0 0 15%;">
                            ...
                            <input type="text" value="<?php echo escapeHtml($ultrasoundRequest['so_ho_so'] ?? $exam['ma_benh_nhan'] ?? '-'); ?>" readonly>
                        </div>
                        <div class="form-group" style="flex: 0 0 45%;">
                            <label>Họ tên người bệnh</label>
                            <input type="text" value="<?php echo escapeHtml($ultrasoundRequest['ho_ten'] ?? $exam['ho_ten'] ?? '-'); ?>" readonly>
                        </div>
                        <div class="form-group" style="flex: 0 0 15%;">
                            <label>Tuổi</label>
                        ...
                        <div class="form-group" style="flex: 0 0 15%;">
                            <label>Nam/Nữ</label>
                            <input type="text" value="<?php echo escapeHtml($ultrasoundRequest['gioi_tinh'] ?? $exam['gioi_tinh'] ?? '-'); ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php 
                                ...
                                if (!empty($exam['doi_tuong_bhyt']) && (int)$exam['doi_tuong_bhyt'] === 1) {
                                    ...
                                    $doiTuong = 'Khác';
                                } elseif (!empty($ultrasoundRequest['doi_tuong'])) {
                                    $doiTuong = $ultrasoundRequest['doi_tuong'];
                                }
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php 
                                // Ưu tiên lấy từ exam
                                $soTheBhyt = $exam['so_the_bhyt'] ?? $ultrasoundRequest['so_the_bhyt'] ?? '-';
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php 
                                $gioChiDinh = '-';
                                if (!empty($ultrasoundRequest['ngay_cap_nhat'])) {
                                    $gioChiDinh = formatTime($ultrasoundRequest['ngay_cap_nhat']);
                                } elseif (!empty($ultrasoundRequest['ngay_tao'])) {
                                    $gioChiDinh = formatTime($ultrasoundRequest['ngay_tao']);
                                }
                    ...
                    <div class="form-row">
                        <div class="form-group full-width">
                            ...
                            <input type="text" value="<?php echo escapeHtml($ultrasoundRequest['chan_doan'] ?? $exam['chan_doan_vao_vien'] ?? '-'); ?>" readonly>
                        </div>
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group full-width">
                            <label style="text-align: center; font-size: 16px;">YÊU CẦU SIÊU ÂM</label>
                            <textarea readonly><?php echo escapeHtml($ultrasoundRequest['yeu_cau'] ?? '-'); ?></textarea>
                        </div>
                    </div>
            ...
            <?php else: ?>
                <div class="no-data">
                    <p>Chưa có phiếu chỉ định siêu âm</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
