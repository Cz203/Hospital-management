            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="patientsTable">
                    ...
                    <tbody>
                        <?php if (!empty($patients)): ?>
                            <?php foreach ($patients as $bn): ?>
                                <tr class="patient-row">
                                    ...
                                    <td>
                                        <?php
                                        $status = $bn['trang_thai_truy_cap'] ?? 'active';
                                        $statusLabels = [
                                            'active' => ['label' => 'Hoạt động', 'class' => 'badge bg-success'],
                                            'inactive' => ['label' => 'Không hoạt động', 'class' => 'badge bg-secondary'],
                                            'blocked' => ['label' => 'Bị chặn', 'class' => 'badge bg-danger'],
                                            'suspended' => ['label' => 'Tạm khóa', 'class' => 'badge bg-warning']
                                        ];
                                        $statusInfo = $statusLabels[$status] ?? $statusLabels['active'];
                                        ?>
                                        <span class="<?php echo htmlspecialchars($statusInfo['class']); ?>">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="9" class="text-center text-muted py-4">Chưa có dữ liệu bệnh nhân.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
